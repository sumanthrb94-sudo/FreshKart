...
export function PromoBanner() {
  const { t } = useLang();
  return (
    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-brand-400 via-brand-500 to-brand-700 px-5 py-4 text-white shadow-[0_10px_24px_-10px_rgba(5,150,105,.4)]">
