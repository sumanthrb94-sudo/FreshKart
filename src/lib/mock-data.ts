...
const RAW: SeedProduct[] = [
  ...
  { name: "Onion (New Red)", category: "vegetables", unit: "kg", price: 24, minOrderQty: 1, stock: 600, origin: "Kurnool, Andhra Pradesh" },
  { name: "Onion (Big)", category: "vegetables", unit: "kg", price: 25, minOrderQty: 1, stock: 480, origin: "Lasalgaon, Maharashtra" },
  { name: "Potato", category: "vegetables", unit: "kg", price: 22, minOrderQty: 1, stock: 750, origin: "Agra, Uttar Pradesh" },
  { name: "Tomato", category: "vegetables", unit: "kg", price: 44, minOrderQty: 1, stock: 320, origin: "Madanapalle, Andhra Pradesh" },
  { name: "Green Chilli", category: "vegetables", unit: "kg", price: 60, minOrderQty: 1, stock: 140, origin: "Guntur, Andhra Pradesh" },
  { name: "Chilli Bajji (Bhajji)", category: "vegetables", unit: "kg", price: 55, minOrderQty: 1, stock: 95, origin: "Guntur, Andhra Pradesh" },
  { name: "Ginger", category: "vegetables", unit: "kg", price: 135, minOrderQty: 1, stock: 80, origin: "Wayanad, Kerala" },
  { name: "Garlic", category: "vegetables", unit: "kg", price: 180, minOrderQty: 1, stock: 18, origin: "Madhya Pradesh" },
  { name: "Cabbage", category: "vegetables", unit: "kg", price: 28, minOrderQty: 1, stock: 260, origin: "Ooty, Tamil Nadu" },
  { name: "Cauliflower", category: "vegetables", unit: "pc", price: 30, minOrderQty: 1, stock: 200, origin: "Karnal, Haryana" },
  { name: "Bottle Gourd", category: "vegetables", unit: "kg", price: 28, minOrderQty: 1, stock: 150, origin: "Kolar, Karnataka" },
  { name: "Ladies Finger (Okra)", category: "vegetables", unit: "kg", price: 38, minOrderQty: 1, stock: 120, origin: "Anand, Gujarat" },
  { name: "Donda (Tindora)", category: "vegetables", unit: "kg", price: 40, minOrderQty: 1, stock: 90, origin: "Kolar, Karnataka" },
  { name: "Ridge Gourd", category: "vegetables", unit: "kg", price: 48, minOrderQty: 1, stock: 110, origin: "Kolar, Karnataka" },
  { name: "Carrot", category: "vegetables", unit: "kg", price: 48, minOrderQty: 1, stock: 220, origin: "Ooty, Tamil Nadu" },
  { name: "Capsicum", category: "vegetables", unit: "kg", price: 55, minOrderQty: 1, stock: 130, origin: "Pune, Maharashtra" },
  { name: "Brinjal (Black)", category: "vegetables", unit: "kg", price: 30, minOrderQty: 1, stock: 160, origin: "Kolar, Karnataka" },
  ...
  { name: "Dosakai (Yellow Cucumber)", category: "vegetables", unit: "kg", price: 35, minOrderQty: 1, stock: 70, origin: "Andhra Pradesh" },
  { name: "Keera (Cucumber)", category: "vegetables", unit: "kg", price: 30, minOrderQty: 1, stock: 240, origin: "Bengaluru Rural, Karnataka" },
  { name: "Beans (French)", category: "vegetables", unit: "kg", price: 90, minOrderQty: 1, stock: 60, origin: "Kodaikanal, Tamil Nadu" },
  ...
  // Leafy Greens
  { name: "Curry Leaves", category: "leafy-greens", unit: "kg", price: 60, minOrderQty: 1, stock: 40, origin: "Tamil Nadu" },
  { name: "Kothimeer (Coriander)", category: "leafy-greens", unit: "kg", price: 90, minOrderQty: 1, stock: 50, origin: "Pune, Maharashtra" },
  { name: "Pudina (Mint)", category: "leafy-greens", unit: "kg", price: 50, minOrderQty: 1, stock: 35, origin: "Pune, Maharashtra" },
  { name: "Palak (Spinach)", category: "leafy-greens", unit: "kg", price: 60, minOrderQty: 1, stock: 8, origin: "Pune, Maharashtra" },
  { name: "Gongura", category: "leafy-greens", unit: "kg", price: 50, minOrderQty: 1, stock: 30, origin: "Telangana" },
  { name: "Thotakura (Amaranth)", category: "leafy-greens", unit: "kg", price: 50, minOrderQty: 1, stock: 28, origin: "Andhra Pradesh" },
  { name: "Methi (Fenugreek)", category: "leafy-greens", unit: "kg", price: 80, minOrderQty: 1, stock: 22, origin: "Nashik, Maharashtra" },
